...
export function generateAgentContext(opts: AgentContextOpts): string {
  ...
  return [
    ...
    "4. Run the full test suite for the implementation repo. Use whatever test",
    "   commands the repo specifies (check README, package.json, Makefile, etc.).",
    "   All tests must pass before opening a PR. Fix any failures and re-run until clean.",
